      ...
      >
        ...
        {showMentions && (
          <motion.div
            ...
            ref={mentionRef}
            className="absolute bottom-full left-4 mb-4 w-[280px] liquid-glass rounded-2xl overflow-hidden z-[60] shadow-2xl"
          >
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              ref={dropdownRef}
              className="absolute bottom-[70px] left-[16px] w-[280px] sm:w-64 liquid-glass rounded-2xl overflow-hidden z-[60] shadow-2xl origin-bottom-left"
            >
