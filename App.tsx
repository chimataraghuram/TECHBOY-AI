...
const App: React.FC = () => {
  ...
  return (
    <div className="relative flex h-[100dvh] w-full bg-transparent overflow-hidden selection:bg-rose-glow/30 selection:text-white">
      ...
      <motion.main 
        animate={{ 
          scale: isSidebarOpen && window.innerWidth < 1024 ? 0.98 : 1, 
          filter: isSidebarOpen && window.innerWidth < 1024 ? 'blur(3px)' : 'blur(0px)' 
        }}
        transition={{ type: "spring", stiffness: 300, damping: 30 }}
        className="relative flex flex-col flex-1 h-[100dvh] min-w-0 overflow-hidden will-change-[transform,filter]"
      >
